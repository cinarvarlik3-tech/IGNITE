...
>(
  (
    ...
    return (
      ...
      >
        <div
          style={{ transition: "width var(--sidebar-duration) var(--sidebar-easing)" }}
          className={cn(
        ...
        />
        <div
          style={{ transition: "left var(--sidebar-duration) var(--sidebar-easing), right var(--sidebar-duration) var(--sidebar-easing), width var(--sidebar-duration) var(--sidebar-easing), translate var(--sidebar-duration) var(--sidebar-easing)" }}
          className={cn(
